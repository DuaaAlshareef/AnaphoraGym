...
```bash
bash scripts/targetted_assessment/analyze_calibration.sh gpt2
```
...
python scripts/targetted_assessment/analysis/add_confidence_metrics.py --model gpt2

# Step 2: Visualize calibration
python scripts/targetted_assessment/visualization/visualize_calibration.py --model gpt2
```
