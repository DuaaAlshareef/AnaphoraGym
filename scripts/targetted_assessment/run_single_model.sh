...
python3 scripts/targetted_assessment/experiments/run_experiment.py --model "$MODEL_NAME"

echo ""
echo "📊 Step 2: Creating visualization..."
python3 scripts/targetted_assessment/visualization/visualize_single_model.py --model "$MODEL_NAME"
