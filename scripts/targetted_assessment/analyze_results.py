# # ==============================================================================
# # SCRIPT: ANALYZE TARGETED ASSESSMENT RESULTS
# #
# # PURPOSE:
# # This is the single, centralized script for analyzing all targeted assessment
# # results. It automatically finds result files, creates a summary table,
...
# # Correctly point to the targeted_assessment results subdirectory
# TARGETED_ASSESSMENT_RESULTS_DIR = os.path.join(RESULTS_DIR, 'targetted_assessment')
# IMAGES_DIR = os.path.join(PROJECT_ROOT, 'images')
# os.makedirs(IMAGES_DIR, exist_ok=True)

# # --- 2. HELPER FUNCTIONS ---
# def analyze_model_performance(results_filename):
#     """Calculates accuracy per condition from a single results CSV."""
...
#     # Save the chart to the main images directory
#     output_path = os.path.join(IMAGES_DIR, "targeted_assessment_comparison_chart.png")
#     plt.savefig(output_path, dpi=300, bbox_inches='tight')
#     print(f"\nPublication-quality chart saved to '{output_path}'")

# # --- 3. MAIN ANALYSIS LOGIC ---
# def main():
#     """Finds all targeted assessment result files, analyzes them, and creates a summary & chart."""
...
#     # Search for files in the correct subdirectory
#     search_pattern = os.path.join(TARGETED_ASSESSMENT_RESULTS_DIR, "AnaphoraGym_Results_*.csv")
#     result_files = glob.glob(search_pattern)

#     if not result_files:
#         print(f"Analysis failed: No result files found in '{TARGETED_ASSESSMENT_RESULTS_DIR}'.")
#         return
...
#         filepath = os.path.join(TARGETED_ASSESSMENT_RESULTS_DIR, f"AnaphoraGym_Results_{model_name}.csv")
...
#     print("\n--- TARGETED ASSESSMENT PERFORMANCE COMPARISON ---")
#     print(final_comparison_table)
    
#     # Save the summary table in the main results directory
#     summary_path = os.path.join(TARGETED_ASSESSMENT_RESULTS_DIR, "targeted_assessment_summary.csv")
