...
python3 scripts/targeted_assessment/analysis/add_confidence_metrics.py --model "$MODEL_NAME"

echo ""
echo "📊 Step 2: Creating calibration visualization..."
python3 scripts/targeted_assessment/visualization/visualize_calibration.py --model "$MODEL_NAME"
