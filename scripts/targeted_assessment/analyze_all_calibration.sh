...
python scripts/targeted_assessment/analysis/add_calibration_to_all_models.py

echo ""
echo "📊 Step 2: Creating calibration comparison visualization..."
python scripts/targeted_assessment/visualization/compare_model_calibration.py
